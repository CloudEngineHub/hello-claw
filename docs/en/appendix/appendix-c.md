...
| [**ClawNet**](https://www.clawnet.hk) | ClawNet | Web browser | — | — | — | — | — | — | Hong Kong-based online Claw service | Users looking for a web-accessible Claw experience |
...
| **Hermes Agent** | Python | Made by Nous Research, self-improving Agent with built-in learning loop, memory, and multi-channel gateway support | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) |
